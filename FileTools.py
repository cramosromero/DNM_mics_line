...
def data_all_events (files, DATA_raw, n_mics, acu_metric):
    ...
    DATA_acu_events = DATA_acu_events - 6 #correction because of the reflective plate Rasmussen
    DATA_raw_events = DATA_raw_events / 2 #correction because of the reflective plate Rasmussen
